...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="YaRaspBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" main.java.Main %CMD_LINE_ARGS%
